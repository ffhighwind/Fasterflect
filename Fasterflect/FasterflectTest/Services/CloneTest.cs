...
namespace FasterflectTest.Services
{
	...
	public class CloneTest
	{
		...
		private class Person
		{
			...
			private readonly Type myType = typeof(Person);
		...
		private class LibraryPoco : Dictionary<string, string>
		{
			public string Name { get; set; }
			public AddressPoco Address { get; set; }
		...
		public void TestDeepCloneWithComplexObjectGraph()
		{
			...
			AddressPoco personAddress = new AddressPoco { City = "Copenhagen", ZipCode = "2300" };
			AddressPoco libraryAddress = new AddressPoco { City = "London" };
			AddressPoco otherAddress = new AddressPoco { City = "Berlin" };
			...
			// deep clone
			LibraryPoco clone = library.DeepClone();
